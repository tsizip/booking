                                                       ...
                                                       <div>
                                                            ...
                                                            <div className='grid grid-cols-6 gap-12'>
                                                                 {phim.lstLichChieuTheoPhim?.slice(0, 6).map((item, index) => {
                                                                      return <NavLink key={index} to={'/'} className='text-xs inline-flex items-center font-bold leading-sm uppercase px-3 py-1 bg-green-200 text-green-700 rounded-full'>{moment(item.ngayChieuGioChieu).format('hh:mm A')}</NavLink>
                                                                 })}
                                                            </div>
                                                       </div>
                                                  </div>
