                    ...
                    <header className="p-4 z-50 dark:bg-gray-800 dark:text-gray-100 bg-opacity-25 bg-black text-white fixed top-0 left-0 right-0">
                         <div className="container flex justify-between h-16 mx-auto">
                              <a rel="noopener noreferrer" href="#" aria-label="Back to homepage" className="flex items-center p-2">
                                   <img src='https://topungdung.online/wp-content/uploads/2020/02/huy-ve-xem-phim.jpg' alt='123' className='' style={{width:'110px'}} />
                              ...
                              <ul className="items-stretch hidden space-x-3 lg:flex">
                                   ...
                                   <li className="flex transition-all duration-200 font-bold">
                                        <NavLink style={({ isActive }) => isActive ? activeStyle : undefined} to='/new' rel="noopener noreferrer" href="#" className=" flex items-center px-4 -mb-1 border-b-0 dark:border-transparent hover:border-b-2 dark:text-violet-400 dark:border-violet-400  border-b-blue-700">
                                             News
                                        </NavLink>
                                   </li>
                                   <li className="flex transition-all duration-200 font-bold">
                                        <NavLink style={({ isActive }) => isActive ? activeStyle : undefined} to='/contact' rel="noopener noreferrer" href="#" className=" flex items-center px-4 -mb-1 border-b-0 dark:border-transparent hover:border-b-2  border-b-blue-700">
                                             Contact
                                        </NavLink>
                                   </li>
                              </ul>
